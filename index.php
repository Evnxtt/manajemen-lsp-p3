...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/img/favicons/Logo180.png">
    <link rel="icon" type="image/png" sizes="32x32" href="assets/img/favicons/Logo32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="assets/img/favicons/Logo16.png">
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/favicons/Logo48.png">
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-5 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.php"><img src="assets/img/EKOLOGIKA.png" height="34" alt="logo" /></a>
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"> </span></button>
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base align-items-lg-center align-items-start">
              <li class="nav-item px-3 px-xl-4"><a class="nav-link fw-medium" aria-current="page" href="#service">Profile</a></li>
              <li class="nav-item px-3 px-xl-4"><a class="nav-link fw-medium" aria-current="page" href="#destination">Statistik</a></li>
              <li class="nav-item px-3 px-xl-4"><a class="nav-link fw-medium" aria-current="page" href="#booking">Sertifikasi</a></li>
              <li class="nav-item px-3 px-xl-4"><a class="nav-link fw-medium" aria-current="page" href="#testimonial">Testimoni</a></li>
              <li class="nav-item px-3 px-xl-4"><a class="btn btn-outline-dark order-1 order-lg-0 fw-medium" href="pages/auth/login.php">Masuk</a></li>
      ...
      <section style="padding-top: 7rem;">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 col-lg-6 order-0 order-md-1 text-end"><img class="pt-7 pt-md-0 hero-img" src="assets/img/hero/Daun2.png" alt="hero-header" /></div>
            <div class="col-md-7 col-lg-6 text-md-start text-center py-6">
              <h4 class="fw-bold text-danger mb-3">Tempat sertifikasi terbaik se Indonesia</h4>
              <h1 class="hero-title">LSP P3 Ekologika</h1>
              <p class="mb-4 fw-medium">Selamat datang di LSP Ekologika, lembaga sertifikasi profesional yang berkomitmen menjaga keberlanjutan lingkungan melalui standar kompetensi terbaik di bidang ekologi dan pengelolaan sumber daya alam.</p>
              <div class="text-center text-md-start"> <a class="btn btn-primary btn-lg me-md-4 mb-3 mb-md-0 border-0 primary-btn-shadow" href="#service" role="button">Lihat Selengkapnya</a>
          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="mb-4 text-start">
                ...
                <h3 class="fs-xl-10 fs-lg-8 fs-7 fw-bold font-cursive text-capitalize">Deskripsi Singkat Tentang Kami</h3>
              </div>
              <div class="d-flex align-items-start mb-5">
                <div class="bg-primary me-sm-4 me-3 p-3" style="border-radius: 13px"> <img src="assets/img/steps/misi.png" width="22" alt="steps" /></div>
                <div class="flex-1">
                  <h5 class="text-secondary fw-bold fs-0">Visi</h5>
                  <p>Menjadi Lembaga Sertifikasi Profesi yang unggul, terpercaya, dan inovatif di bidang ekologi dan lingkungan hidup, yang mampu mencetak sumber daya manusia kompeten, berintegritas tinggi, serta berwawasan keberlanjutan, guna mendukung pembangunan nasional dan diakui secara internasional dalam upaya pelestarian lingkungan dan peningkatan kualitas hidup masyarakat.</p>
                </div>
              </div>
              <div class="d-flex align-items-start mb-5">
                <div class="bg-danger me-sm-4 me-3 p-3" style="border-radius: 13px"> <img src="assets/img/steps/visi.png" width="22" alt="steps" /></div>
                <div class="flex-1">
                  <h5 class="text-secondary fw-bold fs-0">Misi</h5>
                  <p>
                    <ul>
                      <li>
                        Menyelenggarakan sertifikasi kompetensi di bidang ekologi dan lingkungan hidup yang sesuai dengan kebutuhan industri hijau dan masyarakat.
                      </li>
                      <li>
                        Menjamin mutu dan kredibilitas uji kompetensi melalui asesor yang profesional dan skema yang terstandar.
                      </li>
                      <li>
                        Membangun kemitraan strategis dengan dunia usaha dan dunia industri (DUDI), lembaga pendidikan, serta organisasi lingkungan.
                      </li>
                    </ul>
                  </p>
                </div>
            ...
            <div class="col-lg-6 d-flex justify-content-center align-items-start">
              <div class="card position-relative shadow" style="max-width: 370px;">
                ...
                <div class="card-body p-3"> <img class="mb-4 mt-2 rounded-2 w-100" src="assets/img/steps/cover.png" alt="booking" />
                  <div>
                    <h5 class="fw-medium">Manajerial Pertanian</h5>
                    <p class="fs--1 mb-3 fw-medium">14-29 Juni | Al Chakim </p>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                      <div class="d-flex align-items-center mt-n1"><img class="me-3" src="assets/img/steps/building.svg" width="18" alt="building" /><span class="fs--1 fw-medium">24 Orang sedang mengikuti</span></div>
      ...
      <section class="pt-5 pt-md-9" id="service">
        ...
        <div class="container">
          ...
          <div class="mb-7 text-center">
            <h5 class="text-secondary">STATISTIK </h5>
            <h3 class="fs-xl-10 fs-lg-8 fs-7 fw-bold font-cursive text-capitalize">Jejak Dan Jangkauan Kami</h3>
          </div>
          <div class="row">
            <div class="col-lg-3 col-sm-6 mb-6">
              <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                <div class="card-body p-xxl-5 p-4"> <img src="assets/img/category/icon1.png" width="75" alt="Service" />
                  <h4 class="mb-3">200++ Link <br>DUDI Hijau</h4>
                  <p class="mb-0 fw-medium">Perusahaan mitra LSP Ekologi siap menerima tenaga kerja tersertifikasi di bidang lingkungan.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-sm-6 mb-6">
              <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                <div class="card-body p-xxl-5 p-4"> <img src="assets/img/category/icon2.png" width="75" alt="Service" />
                  <h4 class="mb-3">Jejaring Nasional & Internasional</h4>
                  <p class="mb-0 fw-medium">Terhubung dengan jejaring asosiasi lingkungan di tingkat nasional dan global.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-sm-6 mb-6">
              <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                <div class="card-body p-xxl-5 p-4"> <img src="assets/img/category/icon3.png" width="75" alt="Service" />
                  <h4 class="mb-3">800++ SDM Tersertifikasi</h4>
                  <p class="mb-0 fw-medium">Tenaga kerja profesional bidang ekologi yang telah tersertifikasi dan siap berkontribusi.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-sm-6 mb-6">
              <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                <div class="card-body p-xxl-5 p-4"> <img src="assets/img/category/icon4.png" width="75" alt="Service" />
                  <h4 class="mb-3">45 Skema <br>Sertifikasi Ekologi</h4>
                  <p class="mb-0 fw-medium">Skema / Profesi / Jabatan di bidang-bidang strategis sektor Ekologi dan Lingkungan Hidup.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="pt-5" id="destination">
        ...
        <div class="container">
          ...
          <div class="mb-7 text-center">
            <h5 class="text-secondary">SERTIFIKASI</h5>
            <h3 class="fs-xl-10 fs-lg-8 fs-7 fw-bold font-cursive text-capitalize">Sertifikasi Teratas</h3>
          </div>
          <div class="row">
            <div class="col-md-4 mb-4">
              <div class="card overflow-hidden shadow"> <img class="card-img-top" src="assets/img/dest/dest1.png" alt="Rome, Italty" />
                <div class="card-body py-4 px-3">
                  <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
                    <h4 class="text-secondary fw-medium"><a class="link-900 text-decoration-none stretched-link" href="#!">Spesialis Biodiversity</a></h4><span class="fs-1 fw-medium">$5,42k</span>
                  </div>
            ...
            <div class="col-md-4 mb-4">
              <div class="card overflow-hidden shadow"> <img class="card-img-top" src="assets/img/dest/dest2.png" alt="London, UK" />
                <div class="card-body py-4 px-3">
                  <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
                    <h4 class="text-secondary fw-medium"><a class="link-900 text-decoration-none stretched-link" href="#!">Teknik Energi Terbarukan</a></h4><span class="fs-1 fw-medium">$4.2k</span>
                  </div>
            ...
            <div class="col-md-4 mb-4">
              <div class="card overflow-hidden shadow"> <img class="card-img-top" src="assets/img/dest/dest3.png" alt="Full Europe" />
                <div class="card-body py-4 px-3">
                  <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
                    <h4 class="text-secondary fw-medium"><a class="link-900 text-decoration-none stretched-link" href="#!">Teknisi Restorasi Ekosistem</a></h4><span class="fs-1 fw-medium">$15k</span>
                  </div>
          ...
          <div class="row">
            <div class="col-lg-5">
              <div class="mb-8 text-start">
                ...
                <h3 class="fs-xl-10 fs-lg-8 fs-7 fw-bold font-cursive text-capitalize">Testimoni Terverifikasi.</h3>
              </div>
            </div>
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item position-relative active">
                      <div class="card shadow" style="border-radius:10px;">
                        <div class="position-absolute start-0 top-0 translate-middle"> <img class="rounded-circle fit-cover" src="assets/img/testimonial/basit.png" height="65" width="65" alt="" /></div>
                        <div class="card-body p-4">
                          <p class="fw-medium mb-4">&quot;LSP P3 Ekologika meningkatkan keahlian saya di bidang ekologi dengan sertifikasi yang berkualitas.&quot;</p>
                          <h5 class="text-secondary">Basit Rozak</h5>
                          <p class="fw-medium fs--1 mb-0">Lembang, Bandung</p>
                        </div>
                      </div>
                    ...
                    <div class="carousel-item position-relative ">
                      <div class="card shadow" style="border-radius:10px;">
                        <div class="position-absolute start-0 top-0 translate-middle"> <img class="rounded-circle fit-cover" src="assets/img/testimonial/rahma.png" height="65" width="65" alt="" /></div>
                        <div class="card-body p-4">
                          <p class="fw-medium mb-4">&quot;Proses sertifikasi profesional dan relevan dengan kebutuhan industri.&quot;</p>
                          <h5 class="text-secondary">Rahma Aulia</h5>
                          <p class="fw-medium fs--1 mb-0">Cibabat, Cimahi</p>
                        </div>
                      </div>
                      <div class="card shadow-sm position-absolute top-0 z-index--1 mb-3 w-100 h-100" style="border-radius:10px;transform:translate(25px, 25px)"> </div>
                    </div>
                    <div class="carousel-item position-relative ">
                      <div class="card shadow" style="border-radius:10px;">
                        <div class="position-absolute start-0 top-0 translate-middle"> <img class="rounded-circle fit-cover" src="assets/img/testimonial/lulu.png" height="65" width="65" alt="" /></div>
                        <div class="card-body p-4">
                          <p class="fw-medium mb-4">&quot;Sertifikasi ini membuktikan komitmen saya terhadap keberlanjutan lingkungan.&quot;</p>
                          <h5 class="text-secondary">Lulu Nabila</h5>
                          <p class="fw-medium fs--1 mb-0">Jatibening Baru, Bekasi</p>
                        </div>
                      </div>
                      <div class="card shadow-sm position-absolute top-0 z-index--1 mb-3 w-100 h-100" style="border-radius:10px;transform:translate(25px, 25px)"> </div>
                    </div>
      ...
      <section class="pb-0 pb-lg-4">
        ...
        <div class="container">
          <!-- <div class="row">
            <div class="col-lg-3 col-md-7 col-12 mb-4 mb-md-6 mb-lg-0 order-0"> <img class="mb-4" src="assets/img/EKOLOGIKA.png" width="150" alt="jadoo" />
              <p class="fs--1 text-secondary mb-0 fw-medium">Standar keahlian profesional di bidang ekologi dan lingkungan.</p>
            </div>
      ...
      <div class="py-5 text-center">
        <img class="mb-4" src="assets/img/EKOLOGIKA.png" width="150" alt="jadoo" />
      </div>
    </main>
    <!-- ===============================================-->
    <!--    End of Main Content-->
