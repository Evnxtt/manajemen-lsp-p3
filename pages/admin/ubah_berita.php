          ...
          <form class="forms-sample" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <div class="form-group">
                ...
                <textarea class="form-control" id="isi" name="isi" rows="5" placeholder="Isi Berita" required><?= htmlspecialchars($berita['detail_berita']['isi'] ?? '') ?></textarea>
              </div>
              <div class="form-group">
                <label for="penulis">Penulis</label>
                <input type="text" class="form-control" id="penulis" placeholder="Penulis" name="penulis" required value="<?= htmlspecialchars($berita['detail_berita']['penulis'] ?? '') ?>">
              </div>
              <div class="form-group">
